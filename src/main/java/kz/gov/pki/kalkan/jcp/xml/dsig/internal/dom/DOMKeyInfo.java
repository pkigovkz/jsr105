 ...
 *
 */
public final class DOMKeyInfo extends kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMStructure implements KeyInfo {
        ...
        throws MarshalException
    {
        ...
        String dsPrefix = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getSignaturePrefix(context);
        Element kiElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement
            (kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getOwnerDocument(pNode), "KeyInfo",
        ...
        throws MarshalException
    {
        ...
        Element kiElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(ownerDoc, "KeyInfo",
                                                XMLSignature.XMLNS, dsPrefix);
        ...
        throws MarshalException
    {
        ...
        for (XMLStructure kiType : keyInfoTypes) {
            if (kiType instanceof kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMStructure) {
                ((DOMStructure)kiType).marshal(kiElem, dsPrefix, context);
            } else {
                kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.appendChild(kiElem,
