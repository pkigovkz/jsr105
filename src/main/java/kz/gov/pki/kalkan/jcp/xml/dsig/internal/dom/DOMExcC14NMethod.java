...
public final class DOMExcC14NMethod extends ApacheCanonicalizer {
        ...
        throws InvalidAlgorithmParameterException
    {
        ...
        Element paramsElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getFirstChildElement(transformElem);
        if (paramsElem == null) {
            this.params = null;
        ...
        throws MarshalException
    {
        ...
        String prefix = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getNSPrefix(context,
                                             CanonicalizationMethod.EXCLUSIVE);
        Element eElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(ownerDoc,
                                               "InclusiveNamespaces", 
                                               CanonicalizationMethod.EXCLUSIVE,
                                               prefix);
