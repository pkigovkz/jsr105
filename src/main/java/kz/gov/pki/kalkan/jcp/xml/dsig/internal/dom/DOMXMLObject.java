 ...
 *
 */
public final class DOMXMLObject extends kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMStructure implements XMLObject {
    ...
    throws MarshalException
    {
        ...
        this.encoding = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getAttributeValue(objElem, "Encoding");
        ...
        this.mimeType = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getAttributeValue(objElem, "MimeType");
        ...
        for (int idx = 0 ; idx < nnm.getLength() ; idx++) {
            ...
            if (kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.isNamespace(nsDecl)) {
    ...
    public void marshal(Node parent, String dsPrefix, DOMCryptoContext context)
        ...
        if (objElem == null) {
            objElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(ownerDoc, "Object",
                                             XMLSignature.XMLNS, dsPrefix);

            // set attributes
            kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.setAttributeID(objElem, "Id", id);
            kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.setAttribute(objElem, "MimeType", mimeType);
            kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.setAttribute(objElem, "Encoding", encoding);

            // create and append any elements and mixed content, if necessary
            for (XMLStructure object : content) {
                if (object instanceof kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMStructure) {
                    ...
                    kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.appendChild(objElem, domObject.getNode());
                }
            }
        }
