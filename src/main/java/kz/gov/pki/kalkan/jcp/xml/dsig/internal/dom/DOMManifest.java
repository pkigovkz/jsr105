...
public final class DOMManifest extends DOMStructure implements Manifest {
    ...
    {
        this.id = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getIdAttributeValue(manElem, "Id");

        boolean secVal = Utils.secureValidation(context);

        Element refElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getFirstChildElement(manElem, "Reference", XMLSignature.XMLNS);
        List<Reference> refs = new ArrayList<>();
        refs.add(new kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMReference(refElem, context, provider));
        ...
        while (refElem != null) {
            ...
            refs.add(new kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMReference(refElem, context, provider));
            if (secVal && refs.size() > kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMSignedInfo.MAXIMUM_REFERENCE_COUNT) {
        ...
        throws MarshalException
    {
        ...
        Element manElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(ownerDoc, "Manifest",
