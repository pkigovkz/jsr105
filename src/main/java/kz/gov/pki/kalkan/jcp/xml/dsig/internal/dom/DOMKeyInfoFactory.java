...
public final class DOMKeyInfoFactory extends KeyInfoFactory {
    ...
    public KeyInfo newKeyInfo(List content, String id) {
        return new kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMKeyInfo(content, id);
    }
    ...
    public KeyValue newKeyValue(PublicKey key)  throws KeyException {
        ...
        if ("DSA".equals(algorithm)) {
            return new kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMKeyValue.DSA((DSAPublicKey) key);
        } else if ("RSA".equals(algorithm)) {
            return new kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMKeyValue.RSA((RSAPublicKey) key);
    ...
    public PGPData newPGPData(byte[] keyId, byte[] keyPacket, List other) {
        return new kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMPGPData(keyId, keyPacket, other);
    }
