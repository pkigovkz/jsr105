...
public final class DOMXPathFilter2Transform extends ApacheTransform {
        ...
        throws InvalidAlgorithmParameterException
    {
        ...
        try {
            unmarshalParams(kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getFirstChildElement(transformElem));
    ...
    private void unmarshalParams(Element curXPathElem) throws MarshalException
    {
        ...
        while (currentElement != null) {
            ...
            String filterVal = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getAttributeValue(currentElement,
                                                          "Filter");
            if (filterVal == null) {
            ...
            currentElement = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getNextSiblingElement(currentElement);
        }
        ...
        throws MarshalException
    {
        ...
        String prefix = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getNSPrefix(context, Transform.XPATH2);
        String qname = prefix == null || prefix.length() == 0
                       ? "xmlns" : "xmlns:" + prefix;
        @SuppressWarnings("unchecked")
        List<XPathType> xpathList = xp.getXPathList();
        for (XPathType xpathType : xpathList) {
            Element elem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(ownerDoc, "XPath",
