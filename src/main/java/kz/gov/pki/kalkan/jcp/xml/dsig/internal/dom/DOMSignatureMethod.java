...
import kz.gov.pki.kalkan.jcp.xml.dsig.internal.SignerOutputStream;

/**
 * DOM-based abstract implementation of SignatureMethod.
 *
 */
public abstract class DOMSignatureMethod extends kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.AbstractDOMSignatureMethod {
    ...
    DOMSignatureMethod(Element smElem) throws MarshalException {
        Element paramsElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getFirstChildElement(smElem);
        if (paramsElem != null) {
    ...
    static SignatureMethod unmarshal(Element smElem) throws MarshalException {
        ...
        if (alg.equals(SignatureMethod.RSA_SHA1)) {
            ...
            return new kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMHMACSignatureMethod.SHA224(smElem);
        } else if (alg.equals(kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMHMACSignatureMethod.HMAC_SHA256)) {
            return new kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMHMACSignatureMethod.SHA256(smElem);
        } else if (alg.equals(kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMHMACSignatureMethod.HMAC_SHA384)) {
            return new kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMHMACSignatureMethod.SHA384(smElem);
        } else if (alg.equals(kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMHMACSignatureMethod.HMAC_SHA512)) {
            return new kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMHMACSignatureMethod.SHA512(smElem);
        } else if (alg.equals(kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMHMACSignatureMethod.HMAC_RIPEMD160)) {
        ...
        throws InvalidKeyException, SignatureException, XMLSignatureException
    {
        ...
        try (SignerOutputStream outputStream = new SignerOutputStream(signature)) {
            ((kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMSignedInfo)si).canonicalize(context, outputStream);
    ...
    static final class GOST34311withECGOST34310 extends DOMSignatureMethod {
        GOST34311withECGOST34310(AlgorithmParameterSpec params)
                throws InvalidAlgorithmParameterException {
            super(params);
        }
        GOST34311withECGOST34310(Element dmElem) throws MarshalException {
            super(dmElem);
        }
        @Override
        public String getAlgorithm() {
            return ECGOST34310_GOST34311;
        }
        @Override
        String getJCAAlgorithm() {
            return "GOST34311withECGOST34310";
        }
        @Override
        Type getAlgorithmType() {
