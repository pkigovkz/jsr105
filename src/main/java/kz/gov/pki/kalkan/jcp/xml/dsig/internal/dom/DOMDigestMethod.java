...
public abstract class DOMDigestMethod extends DOMStructure
    ...
    DOMDigestMethod(Element dmElem) throws MarshalException {
        Element paramsElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getFirstChildElement(dmElem);
        if (paramsElem != null) {
    ...
    static DigestMethod unmarshal(Element dmElem) throws MarshalException {
        String alg = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getAttributeValue(dmElem, "Algorithm");
        ...
        throws MarshalException
    {
        ...
        Element dmElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(ownerDoc, "DigestMethod",
    ...
    static final class GOST34311 extends DOMDigestMethod {
        GOST34311(AlgorithmParameterSpec params)
                throws InvalidAlgorithmParameterException {
            super(params);
        }
        GOST34311(Element dmElem) throws MarshalException {
            super(dmElem);
        }
        @Override
        public String getAlgorithm() {
