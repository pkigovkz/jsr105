...
public class DOMTransform extends DOMStructure implements Transform {
    ...
    {
        String algorithm = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getAttributeValue(transElem, "Algorithm");
        ...
        throws MarshalException
    {
        ...
        if (parent.getLocalName().equals("Transforms")) {
            transformElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(ownerDoc, "Transform",
                                                   XMLSignature.XMLNS,
                                                   dsPrefix);
        } else {
            transformElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(ownerDoc,
                                                   "CanonicalizationMethod",
                                                   XMLSignature.XMLNS,
                                                   dsPrefix);
        }
        kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.setAttribute(transformElem, "Algorithm", getAlgorithm());
    ...
    public boolean equals(Object o) {
        ...
        return getAlgorithm().equals(otransform.getAlgorithm()) &&
                kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.paramsEqual(getParameterSpec(),
