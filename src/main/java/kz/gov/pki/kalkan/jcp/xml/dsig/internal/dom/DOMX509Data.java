...
public final class DOMX509Data extends DOMStructure implements X509Data {
        ...
        while (firstChild != null) {
            if (firstChild.getNodeType() == Node.ELEMENT_NODE) {
                ...
                if ("X509Certificate".equals(localName) && XMLSignature.XMLNS.equals(namespace)) {
                    ...
                    newContent.add(new kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMX509IssuerSerial(childElem));
        ...
        throws MarshalException
    {
        ...
        Element xdElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(ownerDoc, "X509Data",
        ...
        for (int i = 0, size = content.size(); i < size; i++) {
            ...
            if (object instanceof X509Certificate) {
                ...
                if (object instanceof X509IssuerSerial) {
                    ...
                    kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.appendChild(xdElem, domContent.getNode());
                }
    ...
    private void marshalSKI(byte[] skid, Node parent, Document doc,
                            String dsPrefix)
    {
        Element skidElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(doc, "X509SKI",
                                                  XMLSignature.XMLNS, dsPrefix);
    ...
    private void marshalSubjectName(String name, Node parent, Document doc,
                                    String dsPrefix)
    {
        Element snElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(doc, "X509SubjectName",
                                                XMLSignature.XMLNS, dsPrefix);
    ...
    private void marshalCert(X509Certificate cert, Node parent, Document doc,
        ...
        throws MarshalException
    {
        Element certElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(doc, "X509Certificate",
                                                  XMLSignature.XMLNS, dsPrefix);
        try {
