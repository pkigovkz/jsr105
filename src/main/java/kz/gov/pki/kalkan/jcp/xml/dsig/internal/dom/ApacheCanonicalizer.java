...
public abstract class ApacheCanonicalizer extends TransformService {
        ...
        throws InvalidAlgorithmParameterException
    {
        ...
        ownerDoc = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getOwnerDocument(transformElem);
    }
        ...
        throws TransformException
    {
        if (apacheCanonicalizer == null) {
            try {
                ...
                boolean secVal = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.Utils.secureValidation(xc);
        ...
        try {
            ...
            if (data instanceof kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.ApacheData) {
                XMLSignatureInput in =
                    ((kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.ApacheData)data).getXMLSignatureInput();
                if (in.isElement()) {
                    ...
                    return new OctetStreamData(new ByteArrayInputStream(
                        apacheCanonicalizer.canonicalize(
                            kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.Utils.readBytesFromStream(in.getOctetStream()))));
                }
                ...
                Set<Node> ns = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.Utils.toNodeSet(nsd.iterator());
                nodeSet = ns;
                LOG.debug("Canonicalizing {} nodes", nodeSet.size());
            } else {
                return new OctetStreamData(new ByteArrayInputStream(
                    apacheCanonicalizer.canonicalize(
                        kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.Utils.readBytesFromStream(
        ...
        throws TransformException
    {
        ...
        if (data instanceof kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.ApacheData) {
            ...
            if (data instanceof DOMSubTreeData) {
                ...
                @SuppressWarnings("unchecked")
                Set<Node> nodeSet =
                    kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.Utils.toNodeSet(((NodeSetData)data).iterator());
