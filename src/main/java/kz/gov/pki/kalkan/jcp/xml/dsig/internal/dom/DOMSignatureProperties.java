...
public final class DOMSignatureProperties extends DOMStructure
        ...
        throws MarshalException
    {
        ...
        while (firstChild != null) {
            if (firstChild.getNodeType() == Node.ELEMENT_NODE) {
                ...
                newProperties.add(new kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMSignatureProperty((Element)firstChild));
            }
        ...
        throws MarshalException
    {
        ...
        Element propsElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(ownerDoc,
                                                   "SignatureProperties",
                                                   XMLSignature.XMLNS,
                                                   dsPrefix);
