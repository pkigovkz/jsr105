...
public final class DOMX509IssuerSerial extends DOMStructure
    ...
    public DOMX509IssuerSerial(Element isElem) throws MarshalException {
        Element iNElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getFirstChildElement(isElem,
                                                       "X509IssuerName",
                                                       XMLSignature.XMLNS);
        Element sNElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getNextSiblingElement(iNElem,
                                                        "X509SerialNumber",
                                                        XMLSignature.XMLNS);
        ...
        throws MarshalException
    {
        ...
        Element isElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(ownerDoc, "X509IssuerSerial",
                                                XMLSignature.XMLNS, dsPrefix);
        Element inElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(ownerDoc, "X509IssuerName",
                                                XMLSignature.XMLNS, dsPrefix);
