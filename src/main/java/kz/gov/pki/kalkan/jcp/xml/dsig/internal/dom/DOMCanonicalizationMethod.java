...
public class DOMCanonicalizationMethod extends DOMTransform
    ...
    {
        super(spi);
        if (!(spi instanceof kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.ApacheCanonicalizer) && !isC14Nalg(spi.getAlgorithm())) {
    ...
    private static boolean isC14N11alg(String alg) {
        return alg.equals(kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMCanonicalXMLC14N11Method.C14N_11)
