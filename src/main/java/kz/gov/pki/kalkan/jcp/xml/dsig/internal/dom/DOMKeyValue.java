...
public abstract class DOMKeyValue<K extends PublicKey> extends DOMStructure implements KeyValue {
    ...
    static KeyValue unmarshal(Element kvElem) throws MarshalException {
        Element kvtElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getFirstChildElement(kvElem);
        if (kvtElem == null) {
        ...
        throws MarshalException
    {
        ...
        Element kvElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(ownerDoc, "KeyValue",
    ...
    static final class RSA extends DOMKeyValue<RSAPublicKey> {
        ...
        void marshalPublicKey(Node parent, Document doc, String dsPrefix,
            DOMCryptoContext context) throws MarshalException {
            Element rsaElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(doc, "RSAKeyValue",
                                                     XMLSignature.XMLNS,
                                                     dsPrefix);
            Element modulusElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(doc, "Modulus",
                                                         XMLSignature.XMLNS,
                                                         dsPrefix);
            Element exponentElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(doc, "Exponent",
                                                          XMLSignature.XMLNS,
                                                          dsPrefix);
            ...
            throws MarshalException
        {
            ...
            Element modulusElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getFirstChildElement(kvtElem,
                                                                "Modulus",
                                                                XMLSignature.XMLNS);
            BigInteger modulus = decode(modulusElem);
            Element exponentElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getNextSiblingElement(modulusElem,
                                                                  "Exponent",
                                                                  XMLSignature.XMLNS);
    ...
    static final class DSA extends DOMKeyValue<DSAPublicKey> {
        ...
        void marshalPublicKey(Node parent, Document doc, String dsPrefix,
            ...
            throws MarshalException
        {
            Element dsaElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(doc, "DSAKeyValue",
                                                     XMLSignature.XMLNS,
                                                     dsPrefix);
            // parameters J, Seed & PgenCounter are not included
            Element pElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(doc, "P", XMLSignature.XMLNS,
                                                   dsPrefix);
            Element qElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(doc, "Q", XMLSignature.XMLNS,
                                                   dsPrefix);
            Element gElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(doc, "G", XMLSignature.XMLNS,
                                                   dsPrefix);
            Element yElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(doc, "Y", XMLSignature.XMLNS,
                                                   dsPrefix);
            ...
            throws MarshalException
        {
            ...
            Element curElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getFirstChildElement(kvtElem);
            if (curElem == null) {
                throw new MarshalException("KeyValue must contain at least one type");
            }
            // check for P and Q
            ...
            if (curElem.getLocalName().equals("P") && XMLSignature.XMLNS.equals(curElem.getNamespaceURI())) {
                p = decode(curElem);
                curElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getNextSiblingElement(curElem, "Q", XMLSignature.XMLNS);
                q = decode(curElem);
                curElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getNextSiblingElement(curElem);
            }
            BigInteger g = null;
            if (curElem != null
                && curElem.getLocalName().equals("G") && XMLSignature.XMLNS.equals(curElem.getNamespaceURI())) {
                g = decode(curElem);
                curElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getNextSiblingElement(curElem, "Y", XMLSignature.XMLNS);
            }
            BigInteger y = null;
            if (curElem != null) {
                y = decode(curElem);
    ...
    static final class EC extends DOMKeyValue<ECPublicKey> {
     // ECKeyValue CryptoBinaries
        ...
        void marshalPublicKey(Node parent, Document doc, String dsPrefix,
            ...
            throws MarshalException
        {
            String prefix = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getNSPrefix(context, XMLDSIG_11_XMLNS);
            Element ecKeyValueElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(doc, "ECKeyValue",
                                                            XMLDSIG_11_XMLNS,
                                                            prefix);
            Element namedCurveElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(doc, "NamedCurve",
                                                            XMLDSIG_11_XMLNS,
                                                            prefix);
            Element publicKeyElem = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.createElement(doc, "PublicKey",
                                                           XMLDSIG_11_XMLNS,
                                                           prefix);
            ...
            kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.setAttribute(namedCurveElem, "URI", "urn:oid:" + oid);
            ...
            publicKeyElem.appendChild
                (kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getOwnerDocument(publicKeyElem).createTextNode(encoded));
            ...
            throws MarshalException
        {
            ...
            if (curElem.getLocalName().equals("ECParameters")
                ...
                && XMLDSIG_11_XMLNS.equals(curElem.getNamespaceURI())) {
                String uri = kz.gov.pki.kalkan.jcp.xml.dsig.internal.dom.DOMUtils.getAttributeValue(curElem, "URI");
                // strip off "urn:oid"
